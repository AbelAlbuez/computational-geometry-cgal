...
//
// Usage: ./contour_interpolator slice_A.obj slice_B.obj [output.obj]
// =============================================================================
...
int main( int argc, char** argv )
{
  ...
  // -- (2) Centroid-based alignment: translate both contours to the origin
  //        before interpolating, then translate the result to the average
  ...
  // -- (4) Optimal cyclic rotation of B so vertex correspondences minimise
  //        the sum of squared distances to A.
